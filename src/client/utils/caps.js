...
// See https://en.wikipedia.org/wiki/Tissot%27s_indicatrix .
const txtrpath =
  "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Miller_with_Tissot%27s_Indicatrices_of_Distortion.svg/640px-Miller_with_Tissot%27s_Indicatrices_of_Distortion.svg.png";
...
function setup() {
  ...
  // Geometry.
  const r = 0.2 * Math.min(window.innerWidth, window.innerHeight);
  geom = createCapsule(32, 16, 0, r * 2, r, "ASPECT");

  const texture = new THREE.TextureLoader().load(txtrpath);
